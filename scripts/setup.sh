...
git config --global user.name "Saty Prakash" && \
git config --global user.email "satyapr93@gmail.com" && \
git config --global github.user satyapr93 && \
git config --global core.editor "vim" && \
git config --global color.ui true && \
git config --global push.default simple

#token
git config --global github.token your_token_here ffeebb14527ef881e3968e964903a560bf500cdd
